...
export default function CrisisScreen() {
  ...
  // -------------------------------------------------------------
  // Ajuste da frase pelo gênero
  // -------------------------------------------------------------
  const gender = user?.gender;
  const crisisSubtitle = (() => {
    switch (gender) {
      case "male":
        return "Vamos passar por isso juntos, um passo de cada vez.";
      case "non_binary":
      case "other":
        return "Vamos passar por isso, um passo de cada vez.";
      default:
        return "Vamos passar por isso juntas, um passo de cada vez.";
    }
  })();
