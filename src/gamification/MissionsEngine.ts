...
// helpers só pra deixar os textos mais legais
...
// gerador de XP só pra escalar de leve
...
export class MissionsEngine {
  ...
  // constrói TODAS as missões possíveis (catálogo)
  private buildConfigMissions(): Mission[] {
    ...
    // Quantidade total de registros de humor
  ...
  // mescla storage antigo com o catálogo atual (pra não perder progresso)
  ...
  // Atualiza progresso baseado nas stats globais
  ...
  // até 10 missões ativas de cada vez
  getActiveMissions() {
