...
// ⛔️ DESATIVA A SPLASH IMEDIATAMENTE
SplashScreen.preventAutoHideAsync();  // 🔥 ADICIONADO
...
function InnerNavigation() {
  ...
  useEffect(() => {
    const initAll = async () => {
      ...
      // ✔️ Agora que tudo carregou, esconda a splash:
      SplashScreen.hideAsync();   // 🔥 ADICIONADO
    };
    initAll();
  }, []);
